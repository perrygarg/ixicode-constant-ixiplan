...
public class RouteModelAdapter extends BaseRecyclerAdapter
{
    private ArrayList<GeneralRouteModel> arrayList = null;
    ...
    public RouteModelAdapter(BaseRecyclerAdapterListener baseRecyclerAdapterListener,
                             boolean isPagination, Context context,
                             ArrayList<GeneralRouteModel> arrayList, OnItemClickListener onItemClickListener)
    {
    ...
    {
        public RelativeLayout rView = null;
    ...
    {
        GeneralRouteModel model = arrayList.get(position);
...
//    public void setArrayList(List<DataModelResponse.RoutesModelResponse> arrayList)
//    {
