...
public class FastestRouteAdapter extends BaseRecyclerAdapter
{
    private ArrayList<FastestRouteModel> arrayList = null;
    ...
    public FastestRouteAdapter(BaseRecyclerAdapterListener baseRecyclerAdapterListener,
                               boolean isPagination, Context context,
                               ArrayList<FastestRouteModel> arrayList, OnItemClickListener onItemClickListener)
    {
    ...
    {
        FastestRouteModel model = arrayList.get(position);
        FastestRouteAdapter.LocationViewHolder locationViewHolder = (FastestRouteAdapter.LocationViewHolder) holder;
    ...
    public void setArrayList(List<FastestRouteModel> arrayList)
    {
