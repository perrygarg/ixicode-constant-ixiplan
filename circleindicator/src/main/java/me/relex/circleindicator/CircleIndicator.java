...
public class CircleIndicator extends LinearLayout {
    ...
    public void setmIndicatorBackgroundResId(int mIndicatorBackgroundResId)
    {
        this.mIndicatorBackgroundResId = mIndicatorBackgroundResId;
    }

    public void setmIndicatorUnselectedBackgroundResId(int mIndicatorUnselectedBackgroundResId)
    {
